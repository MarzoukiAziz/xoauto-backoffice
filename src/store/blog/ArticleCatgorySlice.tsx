...
export const fetchCategories = () => async (dispatch: AppDispatch) => {
    try {
        const response = await axios.get(`${API_URL}/settings/article-categories`,);
...
// Add a new category
export const addNewCategory = (newCategory: ArticleCategoryType) => async (dispatch: AppDispatch) => {
    try {
        const response = await axios.post(`${API_URL}/settings/article-categories`, newCategory);
...
export const deleteSelectedCategory = (id: string) => async (dispatch: AppDispatch) => {
    try {
        await axios.delete(`${API_URL}/settings/article-categories/${id}`);
