...
import { TextField, Grid, MenuItem, Button, FormControlLabel, Checkbox, Typography, Box } from '@mui/material';
                ...
                <Grid container spacing={3}>
                    <Grid item xs={12} sm={6}>
                        <FormControlLabel
                            control={
                                <Checkbox
                                    checked={adData.options_vehicule.heads_up_display}
                    ...
                    <Grid item xs={12} sm={6}>
                        <FormControlLabel
                            control={
                                <Checkbox
                                    checked={adData.options_vehicule.parking_assist}
                                    onChange={handleOptionChange}
                                    name="parking_assist"
                                />
                            }
                    ...
                    <Grid item xs={12} sm={6}>
                        <FormControlLabel
                            control={
                                <Checkbox
                                    checked={adData.options_vehicule.tow_hitch}
                                    onChange={handleOptionChange}
                                    name="tow_hitch"
                                />
                            }
                    ...
                    <Grid item xs={12} sm={6}>
                        <FormControlLabel
                            control={
                                <Checkbox
                                    checked={adData.options_vehicule.roof_racks}
                                    onChange={handleOptionChange}
                                    name="roof_racks"
                                />
                            }
                    ...
                    <Grid item xs={12} sm={6}>
                        <FormControlLabel
                            control={
                                <Checkbox
                                    checked={adData.options_vehicule.bluetooth}
                                    onChange={handleOptionChange}
                                    name="bluetooth"
                                />
                            }
                    ...
                    <Grid item xs={12} sm={6}>
                        <FormControlLabel
                            control={
                                <Checkbox
                                    checked={adData.options_vehicule.rear_camera}
                                    onChange={handleOptionChange}
                                    name="rear_camera"
                                />
                            }
                    ...
                    <Grid item xs={12} sm={6}>
                        <FormControlLabel
                            control={
                                <Checkbox
                                    checked={adData.options_vehicule.automatic_climate_control}
                                    onChange={handleOptionChange}
                    ...
                    <Grid item xs={12} sm={6}>
                        <FormControlLabel
                            control={
                                <Checkbox
                                    checked={adData.options_vehicule.gps}
                                    onChange={handleOptionChange}
                                    name="gps"
                                />
                            }
                    ...
                    <Grid item xs={12} sm={6}>
                        <FormControlLabel
                            control={
                                <Checkbox
                                    checked={adData.options_vehicule.rear_radar}
                                    onChange={handleOptionChange}
                                    name="rear_radar"
                                />
                            }
                    ...
                    <Grid item xs={12} sm={6}>
                        <FormControlLabel
                            control={
                                <Checkbox
                                    checked={adData.options_vehicule.leather_seats}
                                    onChange={handleOptionChange}
                                    name="leather_seats"
                                />
                            }
                    ...
                    <Grid item xs={12} sm={6}>
                        <FormControlLabel
                            control={
                                <Checkbox
                                    checked={adData.options_vehicule.heated_seats}
                                    onChange={handleOptionChange}
                                    name="heated_seats"
                                />
                            }
                    ...
                    <Grid item xs={12} sm={6}>
                        <FormControlLabel
                            control={
                                <Checkbox
                                    checked={adData.options_vehicule.sound_system}
                                    onChange={handleOptionChange}
                                    name="sound_system"
                                />
                            }
                    ...
                    <Grid item xs={12} sm={6}>
                        <FormControlLabel
                            control={
                                <Checkbox
                                    checked={adData.options_vehicule.sunroof}
                                    onChange={handleOptionChange}
                                    name="sunroof"
                                />
                            }
                    ...
                    <Grid item xs={12} sm={6}>
                        <FormControlLabel
                            control={
                                <Checkbox
                                    checked={adData.options_vehicule.panoramic_roof}
                                    onChange={handleOptionChange}
                                    name="panoramic_roof"
                                />
                            }
